...
The tools have been tested on Apple MacOS Sierra and Microsoft Windows 8.1.
...
- The "late or early threshold" is the threshold used for the computation of the 'late' and 'early' features (see article for details).
...
The GRAPH tools additionally provide a pdf visualisation of them in the "graph" folder, under the name "graphs.pdf".
...
5. RESULTS
The use of this prototype is to provide a visualization of the use of the resources in a MOOC, based on the "step-activity" csv file provided by FutureLearn. The exact nature of the features that are represented is defined in the article "Resource Usage Analysis from a Different Perspective on MOOC Dropout".